...
<div class="container">
	...
	<span style="font-size:25px; color:blue"><center><strong>User Crud</strong></center></span>
		<span class="pull-left"><a href="#addnew" data-toggle="modal" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Add New</a></span>
		<div style="height:50px;">

            <span class="pull-right"><a href="logout.php" class="btn btn-primary"> Logout</a></span>
        </div>
